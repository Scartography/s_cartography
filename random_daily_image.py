...
#facebook acess
ACCESS_TOKEN = 'EAAGScQCf7wMBAL8rPOeHznz5ZCDx7pAhLreW8pPd4Q3yr6fzvr8SryuSBcK4nrhdOiDcopilZC9ZBwXtAXRKdgOJWa6ZAngglT90JUccOqch9ogfTMLjwQsSLuEF2h4HzZBWpWJs2tX5ZCZCfC6ZAA7jv9liv5UTNhk0dJeYOd2MOgZDZD'
...
path_landscapes = os.getcwd()+ '/_landscapes_web_export/'
...
def random_image(images_path_01, images_path_02):
    ...
    if ',' in message_twitter:
        message_twitter = message_twitter.replace(',', ' #')
...
random_image(images_path_01=path_cities, images_path_02=path_landscapes)
