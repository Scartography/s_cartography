...
#facebook acess
ACCESS_TOKEN = 'EAAGScQCf7wMBAPFoM8FShhpO0L0PNUqrfJ2ZBFeHxLbTZCbze7ZAeDYQhCxDabhRg74V7aabBEznG1Lniut9lzL29wu9Yxcuuc2rKTnZBU7rVIoZAWL0L1qkYAtkEr5TYElxAPYuIPXtPZB0cCjz23WefuwkZCouBPYBGvxwmrqmgZDZD'

graph = GraphAPI(ACCESS_TOKEN)

path_cities = os.getcwd()+'/_landscapes_web_export/'
